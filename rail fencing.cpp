...
int main() {
    ...
    while (1) {
        ...
        if (choice == 1) {
            ...
            scanf(" %99[^\n]", text);  // Read the input text, limit to 99 characters to prevent buffer overflow.
            ...
            scanf(" %99[^\n]", ciphertext);  // Read the input text, limit to 99 characters to prevent buffer overflow.
